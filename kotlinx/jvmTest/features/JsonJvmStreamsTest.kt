...
import kotlinx.serialization.test.generateRandomUnicodeString
...
class JsonJvmStreamsTest {
    val BATCH_SIZE = 6 // kotlinx.serialization.json.internal.BATCH_SIZE
    private val strLen = BATCH_SIZE * 2 + 2

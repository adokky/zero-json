...
import kotlinx.serialization.test.Id
...
class JsonCustomSerializersTest : JsonTestBase() {
    ...
    object BSerializer : KSerializer<B> {
        ...
        override fun deserialize(decoder: Decoder): B { return B(decoder.decodeInt()) }
    }

    @Serializable
    data class BList(@Id(1) val bs: List<B>)

    object CSerializer: KSerializer<C> by C.serializer() {
    ...
    @Serializable
    data class CList1(@Id(1) val c: List<@Serializable(with = CSerializer::class) C>)

    object CList2Serializer : KSerializer<CList2> by CList2.serializer() {
    ...
    @Serializable
    data class CList2(@Id(1) val d: Int = 5, @Id(2) val c: List<@Serializable(with = CSerializer::class) C>)

    object CList3Serializer: KSerializer<CList3> by CList3.serializer() {
    ...
    @Serializable
    data class CList3(@Id(1) val e: List<@Serializable(with = CSerializer::class) C> = emptyList(), @Id(2) val f: Int)

    object CList4Serializer : KSerializer<CList4> by CList4.serializer()  {
    ...
    @Serializable
    data class CList4(@Id(1) val g: List<@Serializable(with = CSerializer::class) C> = emptyList(), @Id(2) val h: Int)

    object CList5Serializer: KSerializer<CList5> by CList5.serializer() {
    ...
    fun testWriteCustomInvertedOrder() = parametrizedTest { jsonTestingMode ->
        val obj = C(1, 2)
        val s = jsonNoAltNames.encodeToString(CSerializer, obj, jsonTestingMode)
    ...
    fun testReadCustomInvertedOrder() = parametrizedTest { jsonTestingMode ->
        val obj = C(1, 2)
        val s = jsonNoAltNames.decodeFromString<C>(CSerializer, """{"b":2,"a":1}""", jsonTestingMode)
        assertEquals(obj, s)
    }
    ...
    fun testReadCustomOmitDefault() = parametrizedTest { jsonTestingMode ->
        val obj = C(b = 2)
        val s = jsonNoAltNames.decodeFromString<C>(CSerializer, """{"b":2}""", jsonTestingMode)
        assertEquals(obj, s)
    }
    ...
    fun testReadListOfOptional() = parametrizedTest { jsonTestingMode ->
        ...
        val s = jsonNoAltNames.decodeFromString(ListSerializer<C>(CSerializer), j, jsonTestingMode)
        assertEquals(obj, s)
    }
    ...
    fun testWriteOptionalList2a() = parametrizedTest { jsonTestingMode ->
        ...
        val s = jsonNoAltNames.encodeToString(CList2Serializer, obj, jsonTestingMode)
    ...
    fun testReadOptionalList2a() = parametrizedTest { jsonTestingMode ->
        ...
        assertEquals(obj, jsonNoAltNames.decodeFromString(CList2Serializer, j, jsonTestingMode))
    }
    ...
    fun testWriteOptionalList3a() = parametrizedTest { jsonTestingMode ->
        ...
        val s = jsonNoAltNames.encodeToString(CList3Serializer, obj, jsonTestingMode)
    ...
    fun testReadOptionalList3a() = parametrizedTest { jsonTestingMode ->
        ...
        assertEquals(obj, jsonNoAltNames.decodeFromString(CList3Serializer, j, jsonTestingMode))
    }
    ...
    fun testWriteOptionalList4a() = parametrizedTest { jsonTestingMode ->
        ...
        val s = jsonNoAltNames.encodeToString(CList4Serializer, obj, jsonTestingMode)
    ...
    fun testReadOptionalList4a() = parametrizedTest { jsonTestingMode ->
        ...
        assertEquals(obj, jsonNoAltNames.decodeFromString(CList4Serializer, j, jsonTestingMode))
    }
    ...
    fun testWriteOptionalList5a() = parametrizedTest { jsonTestingMode ->
        ...
        val s = jsonNoAltNames.encodeToString(CList5Serializer, obj, jsonTestingMode)
    ...
    fun testReadOptionalList5a() = parametrizedTest { jsonTestingMode ->
        ...
        assertEquals(obj, jsonNoAltNames.decodeFromString(CList5Serializer, j, jsonTestingMode))
    }

...
class JsonNullSerializerTest : JsonTestBase() {
    ...
    fun testJsonNullFailure() = parametrizedTest(default) {
        assertFailsWithSerialMessage("ZeroJsonDecodingException", "'null' literal") { default.decodeFromString(JsonNullWrapper.serializer(), "{\"element\":\"foo\"}", JsonTestingMode.STREAMING) }
    }

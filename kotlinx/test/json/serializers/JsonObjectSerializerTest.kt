...
class JsonObjectSerializerTest : JsonTestBase() {
    ...
    fun testMissingCommas() = parametrizedTest { jsonTestingMode ->
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{ \"1\": \"2\" \"3\":\"4\"}", jsonTestingMode) }
    }
    ...
    fun testInvalidObject() = parametrizedTest { jsonTestingMode ->
        assertFailsWithSerial("ZeroJsonDecodingException") { default.decodeFromString(JsonObject.serializer(), "{\"a\":\"b\"]", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { default.decodeFromString(JsonObject.serializer(), "{", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { default.decodeFromString(JsonObject.serializer(), "{}}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { default.decodeFromString(JsonObject.serializer(), "{]", jsonTestingMode) }
    }
    ...
    fun testExcessiveCommas() = parametrizedTest { jsonTestingMode ->
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{\"a\":\"b\",}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{\"a\",}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{,\"1\":\"2\"}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{,\"1\":\"2\",}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{,}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{,,}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{,,\"1\":\"2\"}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{\"1\":\"2\",,}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{\"1\":\"2\",,\"2\":\"2\"}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{,   ,}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(JsonObject.serializer(), "{,\n,}", jsonTestingMode) }
    }
    ...
    fun testExcessiveCommasInObject() = parametrizedTest { jsonTestingMode ->
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{\"a\":\"b\",}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{\"a\",}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{,\"a\":\"b\"}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{,\"a\":\"b\",}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{,}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{,,}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{,,\"a\":\"b\"}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{\"a\":\"b\",,}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{,   ,}", jsonTestingMode) }
        assertFailsWithSerial("ZeroJsonDecodingException") { lenient.decodeFromString(Holder.serializer(), "{,\n,}", jsonTestingMode) }
    }

...
@Serializable
@JvmInline private value class MyInt(val i: Int)

@Serializable
@JvmInline private value class NullableMyInt(val i: Int?)

@Serializable
@JvmInline private value class OverSerializable(val s: IntData)

@Serializable
@JvmInline private value class OverSerializableNullable(val s: IntData?)

@Serializable
@JvmInline private value class WithT<T>(val t: Box<T>)

@Serializable
@JvmInline private value class WithTNullable<T>(val t: Box<T>?)

@Serializable
private data class WithAll(
    val myInt: MyInt, // I
...
@Serializable
private data class WithGenerics(
    val myInt: Box<MyInt>,
